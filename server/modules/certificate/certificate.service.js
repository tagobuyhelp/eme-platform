...
export async function generateCertificatePDF(data) {
  ...
  const html = applyTemplate(template, {
    ...
    studentPhotoHtml: data.studentPhoto ? `<img src="${data.studentPhoto}" alt="Student Photo" style="width: 28mm; height: 28mm; border-radius: 50%; object-fit: cover; vertical-align: middle; margin-right: 4mm; border: 1mm solid #1a4276; box-shadow: 0 0 0 0.5mm #eba834;"/>` : ""
  });
...
export async function generateCertificate(studentId, examId) {
